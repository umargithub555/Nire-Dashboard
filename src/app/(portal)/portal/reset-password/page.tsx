    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-zinc-500 mt-1">Choose a new password for your employee account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 rounded-2xl p-6 space-y-4">
          ...
          <Link href="/portal/forgot-password" className="block text-center text-sm font-medium text-zinc-900 hover:text-zinc-700">
