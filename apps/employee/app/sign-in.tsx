        ...
        >
          <View style={styles.content}>
            ...
            <View style={styles.intro}>
              <View style={styles.badge}><ShieldCheck size={16} color={colors.teal} strokeWidth={2.4} /><Text style={styles.badgeText}>Employee workspace</Text></View>
...
const styles = StyleSheet.create({
  ...
  keyboard: { flex: 1 },
  scroll: { flexGrow: 1, paddingTop: spacing.md, paddingBottom: 140 },
  content: { paddingHorizontal: spacing.xl, gap: 20 },
  ...
  brandLetter: { color: colors.white, fontSize: 18, fontWeight: '900' },
  brandName: { color: colors.ink, fontSize: 20, fontWeight: '800' },
  intro: { gap: 8 },
  badge: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: colors.tealSoft, paddingHorizontal: 10, paddingVertical: 6, borderRadius: radii.pill },
  ...
  inputShell: { minHeight: 50, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, paddingHorizontal: 14, backgroundColor: colors.surfaceMuted, flexDirection: 'row', alignItems: 'center', gap: 10 },
  input: { flex: 1, minWidth: 0, color: colors.ink, fontSize: 15, paddingVertical: 0 },
  footer: { color: colors.inkMuted, fontSize: 12, lineHeight: 18, textAlign: 'center', paddingHorizontal: 12, marginTop: 4 },
})
